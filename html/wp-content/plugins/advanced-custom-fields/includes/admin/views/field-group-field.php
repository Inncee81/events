	...
	<div class="handle">
		<ul class="acf-hl acf-tbody">
			<li class="li-field-order">
				<span class="acf-icon acf-sortable-handle" title="<?php esc_attr_e('Drag to reorder','acf'); ?>"><?php echo ($i + 1); ?></span>
			</li>
			...
			<tbody>
				...
				<tr class="acf-field acf-field-save">
					...
					<td class="acf-input">
						<ul class="acf-hl">
							<li>
								<a class="button edit-field" title="<?php esc_attr_e("Close Field",'acf'); ?>" href="#"><?php esc_html_e("Close Field",'acf'); ?></a>
							</li>
						</ul>
					</td>
				</tr>
