...
<div <?php acf_esc_attr_e($atts); ?>>
	...
	<div class="title acf-soh">
		...
		<div class="actions acf-soh-target">
			<a href="#" data-name="search" class="acf-icon -search grey" title="<?php esc_html_e("Search", 'acf'); ?>"></a>
			<a href="#" data-name="clear" class="acf-icon -cancel grey" title="<?php esc_html_e("Clear location", 'acf'); ?>"></a>
			<a href="#" data-name="locate" class="acf-icon -location grey" title="<?php esc_html_e("Find current location", 'acf'); ?>"></a>
		</div>

		<input class="search" type="text" placeholder="<?php esc_html_e("Search for address...",'acf'); ?>" value="<?php echo esc_attr($field['value']['address']); ?>" />
		<i class="acf-loading"></i>

	</div>

	<div class="canvas" style="height: <?php echo esc_attr($field['height']); ?>px"></div>
