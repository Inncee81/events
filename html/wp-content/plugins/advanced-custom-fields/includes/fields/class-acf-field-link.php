...
<div <?php acf_esc_attr_e($div); ?>>
	...
	<div class="link-wrap">
		...
		?><a class="acf-icon -pencil -clear acf-js-tooltip" data-name="edit" href="#" title="<?php esc_html_e('Edit', 'acf'); ?>"></a><?php
		?><a class="acf-icon -cancel -clear acf-js-tooltip" data-name="remove" href="#" title="<?php esc_html_e('Remove', 'acf'); ?>"></a>
	</div>
