...
<div <?php acf_esc_attr_e($div); ?>>
	...
	<div class="show-if-value file-wrap acf-soh">
		<div class="file-icon">
			<img data-name="icon" src="<?php echo esc_attr($o['icon']); ?>" alt=""/>
		</div>
		<div class="file-info">
			<p>
				<strong data-name="title"><?php echo esc_attr($o['title']); ?></strong>
			</p>
			<p>
				<strong><?php esc_html_e('File name', 'acf'); ?>:</strong>
				<a data-name="filename" href="<?php echo esc_attr($o['url']); ?>" target="_blank"><?php echo esc_attr($o['filename']); ?></a>
			</p>
			<p>
				<strong><?php esc_html_e('File size', 'acf'); ?>:</strong>
				<span data-name="filesize"><?php echo esc_attr($o['filesize']); ?></span>
			</p>
	...
	<div class="hide-if-value">
		<?php if( $uploader == 'basic' ): ?>
			...
			<label class="acf-basic-uploader">
				<input type="file" name="<?php echo esc_attr($field['name']); ?>" id="<?php echo $field['id']; ?>" />
			</label>

		<?php else: ?>

			<p style="margin:0;"><?php esc_html_e('No file selected','acf'); ?> <a data-name="add" class="acf-button button" href="#"><?php esc_html_e('Add File','acf'); ?></a></p>
