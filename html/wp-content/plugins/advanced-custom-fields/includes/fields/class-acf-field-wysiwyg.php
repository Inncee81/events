	...
	*/
	...
	function render_field( $field ) {
		...
		if( version_compare($wp_version, '4.3', '>=' ) ) {
			...
			$button = 'data-wp-editor-id="' . esc_attr($id) . '"';
		...
		<div <?php echo acf_esc_attr($wrap); ?>>
			<div id="wp-<?php echo esc_attr($id); ?>-editor-tools" class="wp-editor-tools hide-if-no-js">
				...
				<?php if( user_can_richedit() && $show_tabs ): ?>
					<div class="wp-editor-tabs">
						<button id="<?php echo esc_attr($id); ?>-tmce" class="wp-switch-editor switch-tmce" <?php echo esc_attr($button); ?> type="button"><?php esc_html_e('Visual', 'acf'); ?></button>
						<button id="<?php echo esc_attr($id); ?>-html" class="wp-switch-editor switch-html" <?php echo esc_attr($button); ?> type="button"><?php echo esc_html_x( 'Text', 'Name for the Text editor tab (formerly HTML)', 'acf' ); ?></button>
					</div>
				<?php endif; ?>
			</div>
			<div id="wp-<?php echo $id; ?>-editor-container" class="wp-editor-container">
				...
				<?php endif; ?>
				<textarea id="<?php echo esc_attr($id); ?>" class="wp-editor-area" name="<?php echo esc_attr($field['name']); ?>" <?php if($height): ?>style="height:<?php echo esc_attr($height); ?>px;"<?php endif; ?>><?php echo esc_textarea($field['value']); ?></textarea>
			</div>
		</div>
		<?php
