	...
	<tbody>
		<?php foreach( $value as $i => $row ):
			...
			<tr class="<?php echo esc_attr($row_class); ?>" data-id="<?php echo esc_attr($i); ?>">
				...
				<?php if( $show_order ): ?>
					<td class="acf-row-handle order" title="<?php esc_attr_e('Drag to reorder','acf'); ?>">
				...
				<?php if( $show_remove ): ?>
					<td class="acf-row-handle remove">
						<a class="acf-icon -plus small acf-js-tooltip" href="#" data-event="add-row" title="<?php esc_html_e('Add row','acf'); ?>"></a>
						<a class="acf-icon -minus small acf-js-tooltip" href="#" data-event="remove-row" title="<?php esc_html_e('Remove row','acf'); ?>"></a>
					</td>
				<?php endif; ?>
