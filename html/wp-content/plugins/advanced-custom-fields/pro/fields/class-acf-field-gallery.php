		...
		<div class="acf-gallery-attachments">
			...
			<?php if( $value ): ?>
				...
				<?php foreach( $value as $i => $v ):
					...
					?>
					<div class="<?php echo esc_attr($a['class']); ?>" data-id="<?php echo esc_attr($a['ID']); ?>">
						<?php acf_hidden_input(array( 'name' => $field['name'].'[]', 'value' => $a['ID'] )); ?>
						<div class="margin">
							<div class="thumbnail">
								<img src="<?php echo esc_url($thumbnail['url']); ?>" alt="" title="<?php echo esc_attr($a['title']); ?>"/>
							</div>
							<?php if( $a['filename'] ): ?>
						...
						<div class="actions">
							<a class="acf-icon -cancel dark acf-gallery-remove" href="#" data-id="<?php echo esc_attr($a['ID']); ?>" title="<?php esc_attr_e('Remove', 'acf'); ?>"></a>
						</div>
					</div>
				<?php endforeach; ?>
