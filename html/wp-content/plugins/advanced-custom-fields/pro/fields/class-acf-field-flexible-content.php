...
<div <?php acf_esc_attr_e( $div ); ?>>
	...
	<ul class="acf-actions acf-hl">
		<li>
			<a class="acf-button button button-primary" href="#" data-name="add-layout"><?php echo esc_html($field['button_label']); ?></a>
		</li>
	</ul>
	...
	<script type="text-html" class="tmpl-popup"><?php
		?><div class="acf-fc-popup"><ul><?php foreach( $layouts as $layout ):
			...
			?><li><a <?php acf_esc_attr_e( $atts ); ?>><?php echo esc_attr($layout['label']); ?></a></li><?php
...
<div <?php echo acf_esc_attr($div); ?>>
	...
	<div class="acf-fc-layout-handle" title="<?php esc_attr_e('Drag to reorder','acf'); ?>" data-name="collapse-layout"><?php echo $title; ?></div>
	...
	<div class="acf-fc-layout-controlls">
		...
		<a class="acf-icon -collapse small acf-js-tooltip" href="#" data-name="collapse-layout" title="<?php esc_attr_e('Click to toggle','acf'); ?>"></a>
	</div>
			...
			<tr>
				<?php foreach( $sub_fields as $sub_field ):
					...
					if( $sub_field['wrapper']['width'] ) {
						...
						$atts['style'] = 'width: ' . esc_attr($sub_field['wrapper']['width']) . '%;';
...
?><tr class="acf-field acf-field-setting-fc_layout" data-name="fc_layout" data-setting="flexible_content" data-id="<?php echo $layout['key']; ?>">
	<td class="acf-label">
		...
		<p class="description acf-fl-actions">
			<a data-name="acf-fc-reorder" title="<?php esc_attr_e("Reorder Layout",'acf'); ?>" ><?php esc_html_e("Reorder",'acf'); ?></a>
			<a data-name="acf-fc-delete" title="<?php esc_attr_e("Delete Layout",'acf'); ?>" href="#"><?php esc_html_e("Delete",'acf'); ?></a>
			<a data-name="acf-fc-duplicate" title="<?php esc_attr_e("Duplicate Layout",'acf'); ?>" href="#"><?php esc_html_e("Duplicate",'acf'); ?></a>
			<a data-name="acf-fc-add" title="<?php esc_attr_e("Add New Layout",'acf'); ?>" href="#"><?php esc_html_e("Add New",'acf'); ?></a>
		</p>
	</td>
	<td class="acf-input">
