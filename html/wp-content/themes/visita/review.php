...
<div>
  <?php if ( get_post_rating() ) : ?>
    <a href="<?php review_link()?>" title="<?php post_review_count() ?>" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
  ...
  <?php if ( comments_open() || get_comments_number() ) : ?>
    <a href="<?php review_add_link()?>" aria-label="<?php _e('Open add review modal', 'visita')?>" data-reviews-add>
